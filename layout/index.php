                ...
                <div  id="counters" class="row row-30 text-center">
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="counter-classic">
                            <div class="counter-classic-number"><span class="icon-lg novi-icon offset-right-10 mercury-icon-time"></span><span class="counter text-white" data-targetnum="<?php foreach ($statsExp as $number) {
                                echo $number['number'];
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="counter-classic">
                            <div class="counter-classic-number"><span class="icon-lg novi-icon offset-right-10 mercury-icon-folder"></span><span class="counter text-white" data-targetnum="<?php foreach ($statsproj as $number) {
                                echo $number['number'];
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="counter-classic">
                            <div class="counter-classic-number"><span class="icon-lg novi-icon offset-right-10 mercury-icon-globe"></span><span class="counter text-white" data-targetnum="<?php foreach ($statscur as $number) {
                                echo $number['number'];
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="counter-classic">
                            <div class="counter-classic-number"><span class="icon-lg novi-icon offset-right-10 mercury-icon-group"></span><span class="counter text-white" data-targetnum="<?php foreach ($statsvis as $number) {
                                echo $number['number'];
...
<div class="call-wrap" id="contact">
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <p>   هذا النص يمكن استبداله باي نص تريد فهو مجرد نص تجريبي  هذا النص يمكن استبداله باي نص تريد فهو مجرد نص تجريبي    هذا النص يمكن استبداله باي نص تريد فهو مجرد نص تجريبي  </p>
            </div>
        </div>
        <div class="col-md-6">
            <form>
            <div class="contactForm formwrap">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                    <input type="text" name="email" placeholder="البريد الالكتروني" class="form-control">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
